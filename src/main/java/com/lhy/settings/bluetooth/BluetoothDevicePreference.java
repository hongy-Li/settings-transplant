...
public final class BluetoothDevicePreference extends Preference implements
    ...
    public BluetoothDevicePreference(Context context, CachedBluetoothDevice cachedDevice) {
        ...
        setLayoutResource(R.layout.bluetooth_item_layout);
...
//        }
    ...
    public void onDeviceAttributesChanged() {
         ...
         */
        SpannableStringBuilder builder = new SpannableStringBuilder(mCachedDevice.getName());
        ForegroundColorSpan redSpan = new ForegroundColorSpan(Color.WHITE);
        builder.setSpan(redSpan, 0, mCachedDevice.getName().length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        setTitle(builder);
    ...
    protected void onBindView(View view) {
        ...
        if (mCachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ...
            if (!um.hasUserRestriction(DISALLOW_CONFIG_BLUETOOTH)) {
                view.findViewById(R.id.preference_bluetooth).setVisibility(View.VISIBLE);
            }
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                BluetoothDevicePreference.this.onClicked();
            }
        });
        ...
        if (btClass != null) {
            switch (btClass.getMajorDeviceClass()) {
                case BluetoothClass.Device.Major.COMPUTER:
                    return R.mipmap.ic_bt_laptop;

                case BluetoothClass.Device.Major.PHONE:
                    return R.mipmap.ic_bt_cellphone;

                case BluetoothClass.Device.Major.PERIPHERAL:
                    return HidProfile.getHidClassDrawable(btClass);

                case BluetoothClass.Device.Major.IMAGING:
                    return R.mipmap.ic_bt_imaging;
...
//            Log.w(TAG, "mBtClass is null");
        ...
        if (btClass != null) {
            if (btClass.doesClassMatch(BluetoothClass.PROFILE_A2DP)) {
                return R.mipmap.ic_bt_headphones_a2dp;

            }
            if (btClass.doesClassMatch(BluetoothClass.PROFILE_HEADSET)) {
                return R.mipmap.ic_bt_headset_hfp;
            }
        }
        return 0;
    }
