...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mProfileContainer = (BluetoothProgressCategory) findPreference(KEY_PROFILE_CONTAINER);
        mDeviceNamePref = (Preference) findPreference(KEY_RENAME_DEVICE);
//        mDeviceNamePref = (EditTextPreference) findPreference(KEY_BACK);
...
//            finish();
        ...
        builder.setSpan(redSpan, 0, deviceName.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        mDeviceNamePref.setSummary(builder);
...
//        }
    ...
    private CheckBoxPreference createProfilePreference(LocalBluetoothProfile profile) {
        BlueCheckPreference pref = new BlueCheckPreference(getActivity());
...
//            finish();
            ...
            renameDialog.setDeviceName(mCachedDevice.getName());
            renameDialog.show();
            return false;
        }
...
//        mDeviceNamePref.setText(deviceName);
    ...
    private void refreshProfilePreference(CheckBoxPreference profilePref,
        ...
        SpannableStringBuilder builder = new SpannableStringBuilder(getText(profile.getSummaryResourceForDevice(device)));
        ForegroundColorSpan redSpan = new ForegroundColorSpan(Color.WHITE);
        builder.setSpan(redSpan, 0, builder.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        profilePref.setSummary(builder);
    }
