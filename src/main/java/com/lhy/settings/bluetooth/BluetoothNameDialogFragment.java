...
public final class BluetoothNameDialogFragment extends DialogFragment implements TextWatcher {
    ...
    private RenameDialog mAlertDialog;
//    private Button mOkButton;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog = new RenameDialog(getActivity()) {
            @Override
            public void submitBtn(String name) {
                BluetoothNameDialogFragment.this.setDeviceName(name);
            }
        };
        mAlertDialog.setTitle(getText(R.string.bluetooth_rename_device));
        mAlertDialog.setDeviceName(deviceName);
        mAlertDialog.show();
